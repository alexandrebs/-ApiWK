package br.com.brazuca.brazucaapi.config;
...
public class SwaggerConfig {
	...
	private static final String BASE_PAKAGE = "br.com.brazuca.brazucaapi.controller";
	private static final String API_TITULO = "Teste Técnico WK Techonology - API ";
	private static final String API_DESCRICAO="API REST que obtem dados de doadores do todo o Brasil em tempo real";
